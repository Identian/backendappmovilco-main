...
{
  public class SolicitudSeleccionarSecuencialDtoValidator : AbstractValidator<SolicitudSeleccionarSecuencialDto>
  {
    public SolicitudSeleccionarSecuencialDtoValidator()
    {
      RuleFor(r => r.IdNumeracion).Cascade(CascadeMode.Stop)
